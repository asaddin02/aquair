...
export default function Pengaturan() {
  ...
  return (
    <Halaman judul="Pengaturan">
      ...
      <section className="card"><div className="sec-head"><h3>Harga per galon</h3></div>
      ...
      <section className="card"><div className="sec-head"><h3>Verifikasi dan Radar</h3></div>
      ...
      <div className="row"><button className="btn btn-primary" onClick={simpan} disabled={kirim || salah || !berubah}>{kirim ? 'Menyimpan…' : 'Simpan pengaturan'}</button>
